#
# # Lista - adresa de momorie unde se stocheaza mai multe informatii intr-un singur loc
# # nu suntem restrictionati de dipul de data (str, int, boolean)
# # merge la fel indexul incepand cu index 0
#
#
# nume_as_list = ('a', 'n', 'd', 'd', 'r', 'e')
# # print(nume_as_list)
# # nume_as_list.index('a')
# # print(nume_as_list.index('a'))
#
# nume_as_list_2 = {'a', 'n', 'd', 'd', 'r', 'e'}
# print(nume_as_list_2[1])
#
# --------------------------------------------------------------------------------------------------------------------------------------------------------------------------
# --------------------------------------------------------------------------------------------------------------------------------------------------------------------------
