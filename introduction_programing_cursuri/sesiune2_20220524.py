# ## asignare - opratiune in case salvam o variabila se numeste adribuire
# #atribuire = proces prin case salvam informatii la adresa de mem identificata cu nume a unei var indiferent de tipul de date al acesteia
#
#
# # operatorii de atribuire/ asignare sunt: = , += (la valoarea curenta se adauga x += 3), -= (se scade cu valoarea), *= (inmultire cu ), / (impartire)
#
#
#
#
#
#
# # operatori aritmetici - permit operatii matematici
# # ex de op aritetici: adunare (+), scadere (-), inmultire (*), impartire (/), modulo (% - returneaza diferenta rezultata din impartire), la putere (**), floor division(// - de cate ori intra in)
#
#
#
#
# # operatorii de comparare, prin intermediul lor putem compara 2 val distincte, vor fi utili in assert
#
#
#
#
# # operatorii logici
# # sunt fol pt a defini eval mai complexe formate din mai mukte cond de eval
# # AND  OR  NOT
#
# #conditie compusa care instruieste sitemul sa evalueze ca fiind adevarata doar daca conditiile simple pe cARE LE CONTINE SUNT EVAL CA FIIND ADEVARATE
#
#
#
#
